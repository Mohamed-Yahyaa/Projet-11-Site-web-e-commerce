  ...
  public function initCode() {
    ...
    public function set($cart, $product, $quantity){
      ...
      public function getCartProducts($cartId){
        ...
        $sql = "SELECT * FROM chariot_line INNER JOIN product on chariot_line.idChariotline = product.id_Product WHERE idCart = $cartId";
        $query = mysqli_query($this->getConnection(), $sql);
        $result =  mysqli_fetch_all($query, MYSQLI_ASSOC);
        return $result;
        $product = new Product();
    ...
    public function getProductCart($idCartLine){
        $sql = "SELECT * FROM chariot_line INNER JOIN product on chariot_line.idProduct = product.id_Product WHERE idCartLine = $idCartLine";
        $query = mysqli_query($this->getConnection(),$sql);
